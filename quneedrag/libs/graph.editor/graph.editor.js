!function (t, e) {
  ...
  function r(e, n, i) {
    ...
    var r = {
      interactionModes: [{
        ...
        action: a
      }, {name: "浏览模式", value: t.Consts.INTERACTION_MODE_VIEW, iconClass: "icon toolbar-pan", action: a}],
      zoom: [{
      ...
      editor: [{
        ...
        action: a
      }, {name: "创建线条", value: t.Consts.INTERACTION_MODE_CREATE_LINE, iconClass: "icon toolbar-line", action: a}],
      search: {
        name: "Find",
        placeholder: "Name",
  ...
  r.prototype = {
    ...
    createToolbox: function () {
      ...
      return t ? this.toolbox = t : (this.toolbox = t = i("graph-editor__toolbox", this.dom), t.setAttribute("data-options", "region:'west',width:70 "), t)
    },
   ...
   /*   var o = [{label: "Node", image: "Q-node"}, {
        ...
        styles: {"label.background.color": "#2898E0", "label.color": "#FFF", "label.padding": new t.Insets(3, 5)}
      },
